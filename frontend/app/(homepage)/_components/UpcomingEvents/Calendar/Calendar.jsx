  ...
  return (
    <div className="event-calendar">
      <div className="event-calendar-header">
        ...
        <CircleChevronLeft onClick={() => handleMonthChange(-1)} className="calendar-button next" />
        
        <div className="current-month-text">
          {months[currentMonth]}, {currentDate.getFullYear()}
        </div>

        <CircleChevronRight onClick={() => handleMonthChange(1)} className="calendar-button next" />
      ...
      <div className="event-calendar-body">
        ...
        {range(1, currentMonthDays + 1, currentMonthFirstDay).map(
          (value, index) => {
            return (
              <div className={value === 5 ? "event" : null} key={index}>
                {value}
              </div>
            );
          }
